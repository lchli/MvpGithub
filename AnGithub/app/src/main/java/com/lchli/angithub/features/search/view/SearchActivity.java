...
public class SearchActivity extends BaseAppCompatActivity {
  ...
  private String sortField = ServerConst.Repo.SORT_FIELD_STAR;
  private String sortOrder = ServerConst.Repo.SORT_ORDER_DESC;
  ...
  private SearchController.Callback searchCb = new SearchController.Callback() {
    ...
    public void onSucess(List<ReposResponse.Repo> items) {
      RefreshUtils.onRefreshComplete(searchListView);
